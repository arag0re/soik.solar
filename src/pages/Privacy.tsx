         ...
         <main className="max-w-3xl mx-auto px-6 pt-20 pb-12">
            ...
            <div className="mb-8">
               ...
               <h1 className="text-3xl font-semibold mt-2">
                  Datenschutzerklärung der soik.solar GmbH
               </h1>
            </div>
            ...
            <div className="space-y-6 text-sm leading-7 text-slate-700">
               <div className="space-y-3">
                  ...
                  <p>
                     ...
                     Geschäftsleitung der soik.solar GmbH. Eine Nutzung der
                     Internetseiten der soik.solar GmbH ist grundsätzlich ohne
                     jede Angabe personenbezogener Daten möglich. Sofern eine
                     betroffene Person besondere Services unseres Unternehmens
                     über unsere Internetseite in Anspruch nehmen möchte, könnte
                  ...
                  <p>
                     ...
                     des Namens, der Anschrift, E-Mail-Adresse oder
                     Telefonnummer einer betroffenen Person, erfolgt stets im
                     Einklang mit der Datenschutz-Grundverordnung und in
                     Übereinstimmung mit den für die soik.solar GmbH geltenden
                     ...
                     Daten informieren. Ferner werden betroffene Personen
                     mittels dieser Datenschutzerklärung über die ihnen
                     zustehenden Rechte aufgeklärt.
                  </p>
                  <p>
                     Die soik.solar GmbH hat als für die Verarbeitung
                     Verantwortlicher zahlreiche technische und organisatorische
                     Maßnahmen umgesetzt, um einen möglichst lückenlosen Schutz
                     der über diese Internetseite verarbeiteten
                     personenbezogenen Daten sicherzustellen. Dennoch können
                     Internetbasierte Datenübertragungen grundsätzlich
                     Sicherheitslücken aufweisen, sodass ein absoluter Schutz
                     nicht gewährleistet werden kann. Aus diesem Grund steht es
                     jeder betroffenen Person frei, personenbezogene Daten auch
                     auf alternativen Wegen, beispielsweise telefonisch, an uns
                     zu übermitteln.
                  </p>
               </div>
               ...
               <section className="space-y-3">
                  ...
                  <p>
                     Die Datenschutzerklärung der soik.solar GmbH beruht auf den
                  ...
                  <ul className="list-none space-y-6">
                     ...
                     <li>
                        ...
                        <p className="text-slate-600">
                           ...
                           werden, um bestimmte persönliche Aspekte, die sich
                           auf eine natürliche Person beziehen, zu bewerten,
                     ...
                     <li>
                        ...
                        <p className="text-slate-600">
                           ...
                           einer identifizierten oder identifizierbaren
               ...
               <section className="space-y-3">
                  ...
                  <div className="space-y-1 text-slate-600">
                     <p>soik.solar GmbH</p>
                     <p>Sophienstrasse 8</p>
                     <p>98693 Ilmenau</p>
                     <p>Deutschland</p>
                     <p>Tel.: 0123456789</p>
                     <p>E-Mail: ss@soik.solar</p>
                     <p>Website: https://soik.solar</p>
                  </div>
               </section>
               ...
               <section className="space-y-3">
                  ...
                  <p>
                     Die Internetseiten der soik.solar GmbH verwenden Cookies.
                  ...
                  <p>
                     ...
                     können, in dem das Cookie gespeichert wurde. Dies
                  ...
                  <p>
                     Durch den Einsatz von Cookies kann die soik.solar GmbH den
                  ...
                  <p>
                     ...
                     werden. Dies ist in allen gängigen Internetbrowsern
                     möglich. Deaktiviert die betroffene Person die Setzung von
               ...
               <section className="space-y-3">
                  ...
                  <p>
                     ...
                     notwendigen Informationen bereitzustellen. Diese anonym
                     erhobenen Daten und Informationen werden durch die
                     soik.solar GmbH daher einerseits statistisch und ferner mit
                     dem Ziel ausgewertet, den Datenschutz und die
                     Datensicherheit in unserem Unternehmen zu erhöhen, um
                     letztlich ein optimales Schutzniveau für die von uns
                     verarbeiteten personenbezogenen Daten sicherzustellen. Die
                     anonymen Daten der Server-Logfiles werden getrennt von
                     allen durch eine betroffene Person angegebenen
               ...
               <section className="space-y-3">
                  ...
                  <p>
                     Auf der Internetseite der soik.solar GmbH wird den
                     Benutzern die Möglichkeit eingeräumt, den Newsletter
                     unseres Unternehmens zu abonnieren. Welche
                     personenbezogenen Daten bei der Bestellung des Newsletters
                     an den für die Verarbeitung Verantwortlichen übermittelt
                     werden, ergibt sich aus der hierzu verwendeten
                     Eingabemaske.
                  </p>
                  <p>
                     Die soik.solar GmbH informiert ihre Kunden und
                     ...
                     grundsätzlich nur dann empfangen werden, wenn (1) die
                     betroffene Person über eine gültige E-Mail-Adresse verfügt
                     und (2) die betroffene Person sich für den
                     Newsletterversand registriert. An die von einer betroffenen
                     Person erstmalig für den Newsletterversand eingetragene
                     E-Mail-Adresse wird aus rechtlichen Gründen eine
                     Bestätigungsmail im Double-Opt-In-Verfahren versendet.
                     Diese Bestätigungsmail dient der Überprüfung, ob der
                  ...
                  <p>
                     ...
                     verwendeten Computersystems sowie das Datum und die Uhrzeit
                     der Anmeldung. Die Erhebung dieser Daten ist erforderlich,
                     um den(möglichen) Missbrauch der E-Mail-Adresse einer
                     betroffenen Person zu einem späteren Zeitpunkt
                     nachvollziehen zu können und dient deshalb der rechtlichen
                  ...
                  <p>
                     ...
                     unseres Newsletters verwendet. Ferner könnten Abonnenten
                     des Newsletters per E-Mail informiert werden, sofern dies
                     für den Betrieb des Newsletter-Dienstes oder eine
                     diesbezügliche Registrierung erforderlich ist, wie dies im
                     Falle von Änderungen am Newsletterangebot oder bei der
                     Veränderung der technischen Gegebenheiten der Fall sein
                     könnte. Es erfolgt keine Weitergabe der im Rahmen des
                     Newsletter-Dienstes erhobenen personenbezogenen Daten an
                     Dritte. Das Abonnement unseres Newsletters kann durch die
                     ...
                     erteilt hat, kann jederzeit widerrufen werden. Zum Zwecke
                     des Widerrufs der Einwilligung findet sich in jedem
                     Newsletter ein entsprechender Link. Ferner besteht die
                     Möglichkeit, sich jederzeit auch direkt auf der
               ...
               <section className="space-y-3">
                  ...
                  <p>
                     Die Newsletter der soik.solar GmbH enthalten sogenannte
                     Zählpixel. Ein Zählpixel ist eine Miniaturgrafik, die in
                     solche E-Mails eingebettet wird, welche im HTML-Format
                     versendet werden, um eine Logdatei-Aufzeichnung und eine
                     Logdatei-Analyse zu ermöglichen. Dadurch kann eine
                     statistische Auswertung des Erfolges oder Misserfolges von
                     Online-Marketing-Kampagnen durchgeführt werden. Anhand des
                     eingebetteten Zählpixels kann die soik.solar GmbH erkennen,
                     ob und wann eine E-Mail von einer betroffenen Person
                     geöffnet wurde und welche in der E-Mail befindlichen Links
                  ...
                  <p>
                     ...
                     Verarbeitung Verantwortlichen gespeichert und ausgewertet,
                     um den Newsletterversand zu optimieren und den Inhalt
                     zukünftiger Newsletter noch besser den Interessen der
                     betroffenen Person anzupassen. Diese personenbezogenen
                     Daten werden nicht an Dritte weitergegeben. Betroffene
                     Personen sind jederzeit berechtigt, die diesbezügliche
                     gesonderte, über das Double-Opt-In-Verfahren abgegebene
                     Einwilligungserklärung zu widerrufen. Nach einem Widerruf
                     werden diese personenbezogenen Daten von dem für die
                     Verarbeitung Verantwortlichen gelöscht. Eine Abmeldung vom
                     Erhalt des Newsletters deutet die soik.solar GmbH
               ...
               <section className="space-y-3">
                  ...
                  <p>
                     Die Internetseite der soik.solar GmbH enthält aufgrund von
                     gesetzlichen Vorschriften Angaben, die eine schnelle
                     elektronische Kontaktaufnahme zu unserem Unternehmen sowie
                     eine unmittelbare Kommunikation mit uns ermöglichen, was
                     ebenfalls eine allgemeine Adresse der sogenannten
                     elektronischen Post (E-Mail-Adresse) umfasst. Sofern eine
                     betroffene Person per E-Mail oder über ein Kontaktformular
                     den Kontakt mit dem für die Verarbeitung Verantwortlichen
                     aufnimmt, werden die von der betroffenen Person
                     übermittelten personenbezogenen Daten automatisch
                     gespeichert. Solche auf freiwilliger Basis von einer
                     betroffenen Person an den für die Verarbeitung
                     Verantwortlichen übermittelten personenbezogenen Daten
                     werden für Zwecke der Bearbeitung oder der Kontaktaufnahme
                     zur betroffenen Person gespeichert. Es erfolgt keine
               ...
               <section className="space-y-3">
                  <h2 className="text-lg font-semibold text-slate-900">
                     8. Routinemäßige Löschung und Sperrung von
               ...
               <section className="space-y-3">
                  ...
                  <ul className="list-none space-y-6 text-slate-700">
                     <li>
                        <h3 className="text-base font-semibold text-slate-900">
                     ...
                     <li>
                        ...
                        <p>
                           ...
                           der betroffenen Person Auskunft über folgende
                           Informationen zugestanden:
                        </p>
                        <ul className="list-none space-y-1 pl-4 text-slate-600">
                           ...
                           <li>
                              ...
                              falls dies nicht möglich ist, die Kriterien für
                        ...
                        <p>
                           ...
                           Organisation übermittelt wurden. Sofern dies der Fall
                           ist, so steht der betroffenen Person im Übrigen das
                     ...
                     <li>
                        ...
                        <p>
                           ...
                           unverzügliche Berichtigung sie betreffender
                     ...
                     <li>
                        ...
                        <p>
                           Jede von der Verarbeitung personenbezogener Daten
                           betroffene Person hat das vom Europäischen
                           Richtlinien- und Verordnungsgeber gewährte Recht, von
                           dem Verantwortlichen zu verlangen, dass die sie
                        ...
                        <ul className="list-none space-y-1 pl-4 text-slate-600">
                           ...
                           <li>
                              ...
                              DS-GVO stützte, und es fehlt an einer
                           ...
                           <li>
                              ...
                              es liegen keine vorrangigen berechtigten Gründe
                              für die Verarbeitung vor, oder die betroffene
                              Person legt gemäß Art. 21 Abs. 2 DS-GVO
                        ...
                        <p>
                           ...
                           personenbezogenen Daten, die bei der soik.solar GmbH
                           gespeichert sind, veranlassen möchte, kann sie sich
                           hierzu jederzeit an einen Mitarbeiter des für die
                           Verarbeitung Verantwortlichen wenden. Der Mitarbeiter
                           der soik.solar GmbH wird veranlassen, dass dem
                           Löschverlangen unverzüglich nachgekommen wird.
                        </p>
                        <p>
                           Wurden die personenbezogenen Daten von der soik.solar
                           GmbH öffentlich gemacht und ist unser Unternehmen als
                           Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur
                           Löschung der personenbezogenen Daten verpflichtet, so
                           trifft die soik.solar GmbH unter Berücksichtigung der
                           ...
                           Der Mitarbeiter der soik.solar GmbH wird im
                     ...
                     <li>
                        ...
                        <p>
                           ...
                           betroffene Person hat das vom Europäischen
                           Richtlinien- und Verordnungsgeber gewährte Recht, von
                           dem Verantwortlichen die Einschränkung der
                        ...
                        <ul className="list-none space-y-1 pl-4 text-slate-600">
                           ...
                           <li>
                              ...
                              länger, die betroffene Person benötigt sie jedoch
                     ...
                     <li>
                        ...
                        <p>
                           ...
                           betroffene Person hat das vom Europäischen
                           Richtlinien- und Verordnungsgeber gewährte Recht, die
                           sie betreffenden personenbezogenen Daten, welche
                        ...
                        <p>
                           ...
                           jederzeit an einen Mitarbeiter der soik.solar GmbH
                           wenden.
                        </p>
                     </li>
                     <li>
                        ...
                        <p>
                           ...
                           von Art. 6 Abs. 1 Buchstaben e oder f DS-GVO erfolgt,
                           Widerspruch einzulegen. Dies gilt auch für ein auf
                           diese Bestimmungen gestütztes Profiling.
                        </p>
                        <p>
                           Die soik.solar GmbH verarbeitet die personenbezogenen
                        ...
                        <p>
                           Verarbeitet die soik.solar GmbH personenbezogene
                           Daten, um Direktwerbung zu betreiben, so hat die
                           betroffene Person das Recht, jederzeit Widerspruch
                           ...
                           Direktwerbung in Verbindung steht. Widerspricht die
                           betroffene Person gegenüber der soik.solar GmbH der
                           Verarbeitung für Zwecke der Direktwerbung, so hat sie
                           das Recht, dass die Verarbeitung der
