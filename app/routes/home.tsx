      ...
      <header className="fixed top-0 left-0 w-full z-50 bg-transparent">
         <div className="flex items-center flex-shrink-0">
            <div className="flex items-center flex-shrink-0 pl-4">
               ...
               <Link
                  to="/"
                  className="whitespace-nowrap text-white text-4xl font-bold"
               >
            ...
            <div className="flex-1 flex justify-center pt-4">
               <nav className="bg-white rounded-3xl shadow-2xl px-8 h-14 flex items-center">
            ...
            {/* RIGHT: EMPTY BALANCE (optional for symmetry) */}
            <WhatsAppButton />
